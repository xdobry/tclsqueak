IDE::GuiClassTemplate instproc init window {
    my instvar win root

    %%if {[dict get $desc ooSystemType] eq "XOTcl"} {# you need this if you want do bind object variables to tk widgets (for example -textvariable)
    my requireNamespace} {}%%
