IDE::ObjectBrowser instproc fillMenuStruct ms {
   ...
   $ms addCommand2 {Track Object} [list [self] trackObject] {hasObject isObjectXOTcl}
   ...
   $ms addCommand2 {Print printString} [list [self] printString] {hasObject isObjectXOTcl}
   $ms addCommand2 {Print Filters} [list [self] printFilters] {hasObject isObjectXOTcl}
}
